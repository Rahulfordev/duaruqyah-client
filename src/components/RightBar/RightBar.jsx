...
const RightBar = ({ showSetting }) => {
  return (
    <div
      className={`setting ${
        showSetting ? "open" : "closed"
      } absolute 2xl:static`}
    >
      <div className="overflow-hidden w-[330px] h-[534px] sm:h-[734px] lg:h-[834px] bg-white rounded-[32px] border-black">
        <div className="">
